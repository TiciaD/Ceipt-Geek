...
from .auth.schema import schema as auth_schema

class Query(tags_schema.TagQuery, users_schema.UserQuery, receipts_schema.Query, ObjectType):
    pass

class Mutation(tags_schema.TagMutation, users_schema.UserMutation, receipts_schema.Mutation, auth_schema.AuthMutation, ObjectType):
    pass
